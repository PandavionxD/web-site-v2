  ...
  return (
    ...
    <div className="min-h-[calc(100vh-7rem)] w-full mx-auto grid place-content-center gap-3 ">
      ...
      <div className="flex gap-5 flex-col absolute bottom-5 z-10 left-3 md:left-10 ">
        <button className="p-2 overflow-hidden bg-gray-200 rounded-md dark:hover:bg-purple-600 hover:bg-indigo-600 hover:text-white hover:-translate-x-2 transition-all duration-300 " >
